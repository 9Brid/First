...
public class Q07 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        BufferedInputStream inputStream = new BufferedInputStream(new FileInputStream("src/han01/q07_1.txt"));
        ...
        System.out.println("peek:" + peak + ", valley:" + valley);
        stdin.close();
    }

    static private void bfs(int x, int y, boolean[] hasHigher, boolean[] hasLower ){
        int front = 0, rear = 0;
        q[rear++] = new Pair(x, y);
        inq[x][y] = true;
